...
@Component({
  selector: 'app-advancedsignsof-ageing',
  templateUrl: './advancedsignsof-ageing.page.html',
  styleUrls: ['./advancedsignsof-ageing.page.scss'],
})
export class AdvancedsignsofAgeingPage {
