...
@Component({
  selector: 'app-tintedcomplexion',
  templateUrl: './tintedcomplexion.page.html',
  styleUrls: ['./tintedcomplexion.page.scss'],
})
export class TintedcomplexionPage implements OnInit {
